...
// The 2 function-blocks below are for making the variables writable, as they are only readable by default
...
addMatrixVariable(UA_Server *server) {
	UA_VariableAttributes attr = UA_VariableAttributes_default;
	attr.displayName = UA_LOCALIZEDTEXT("en-UA", "Double Matrix");
	attr.accessLevel = UA_ACCESSLEVELMASK_READ | UA_ACCESSLEVELMASK_WRITE;
...
// Now we change the value of the variable with the write service
static void
writeVariable(UA_Server *server){
	...
	* attribute with the write service. */
	...
	/* Reset the variable to a good status code with a value */
